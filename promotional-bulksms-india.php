...
<head>
    ...
    <title>Promotional Bulk SMS | Cheapsms.com</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="feature-grid">
                <div class="card">
                    ...
                    <p>Send millions of SMS in minutes. Messages delivered in under 10 seconds on average across all major operators.</p>
                </div>
                <div class="card">
                    <div class="card-icon">🌐</div>
    ...
    <section class="container pricing">
        <h2 class="section-title" style="text-align: left;">Promotional SMS(India) <span class="text-red">Pricing</span></h2>
        ...
        <table>
            ...
            <tbody>
                <tr><td><strong>50,000</strong></td><td>16p</td><td><strong>₹8,000</strong></td><td><button 
            type="button" 
            class="btn-primary" 
            ...
            onclick="window.location.href='payment.php?Quantity=50,000&Paisa=16p&Total=₹8,000';">
            Buy Now
        </button>
    </td>
</tr>
                <tr><td><strong>1,00,000</strong></td><td>14p</td><td><strong>₹14,000</strong></td><td><button 
            type="button" 
            class="btn-primary" 
            style="padding: 8px 16px; font-size: 12px; background-color: #F22F46; color: white; border: none; border-radius: 4px; cursor: pointer; font-family: 'Inter', sans-serif; font-weight: 600;" 
            onclick="window.location.href='payment.php?Quantity=1,00,000&Paisa=14p&Total=₹14,000';">
            Buy Now
        </button>
    </td>
</tr>
  <tr><td><strong>2,00,000</strong></td><td>13p</td><td><strong>₹26,000</strong></td><td><button 
            type="button" 
            class="btn-primary" 
            style="padding: 8px 16px; font-size: 12px; background-color: #F22F46; color: white; border: none; border-radius: 4px; cursor: pointer; font-family: 'Inter', sans-serif; font-weight: 600;" 
            onclick="window.location.href='payment.php?Quantity=2,00,000&Paisa=13p&Total=₹26,000';">
            Buy Now
        </button>
    </td>
</tr>
                <tr><td><strong>5,00,000</strong></td><td>12.5p</td><td><strong>₹62,500</strong></td><td><button 
            type="button" 
            class="btn-primary" 
            style="padding: 8px 16px; font-size: 12px; background-color: #F22F46; color: white; border: none; border-radius: 4px; cursor: pointer; font-family: 'Inter', sans-serif; font-weight: 600;" 
            onclick="window.location.href='payment.php?Quantity=5,00,000&Paisa=12.5p&Total=₹62,500';">
            Buy Now
        </button>
    </td>
</tr>
                <tr><td><strong>10,00,000</strong></td><td>12p</td><td><strong>₹1,20,000</strong></td><td><button 
            type="button" 
            class="btn-primary" 
            style="padding: 8px 16px; font-size: 12px; background-color: #F22F46; color: white; border: none; border-radius: 4px; cursor: pointer; font-family: 'Inter', sans-serif; font-weight: 600;" 
            onclick="window.location.href='payment.php?Quantity=10,00,000&Paisa=12p&Total=₹120,000';">
            Buy Now
        </button>
    </td>
</tr>
