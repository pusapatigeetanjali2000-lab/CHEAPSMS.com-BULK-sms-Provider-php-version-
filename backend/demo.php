        ...
        <div style="text-align:center;margin-bottom:16px;">
            ...
            <div style="display:flex;justify-content:center;gap:10px;flex-wrap:wrap;">
                <div style="display:inline-flex;align-items:center;gap:6px;background:#FFFBF0;border:1px solid rgba(251,188,5,0.3);border-radius:20px;padding:5px 14px;">
                    ...
                    <span style="color:var(--text-muted);font-size:12px;">4.9 · Google 200+ Reviews</span>
                </div>
                <div style="display:inline-flex;align-items:center;gap:6px;background:#F0FFF8;border:1px solid rgba(0,182,122,0.3);border-radius:20px;padding:5px 14px;">
                    ...
                    <span style="color:var(--text-muted);font-size:12px;">4.8 · Trustpilot 300+ Reviews</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <form id="demoForm" >
        <div class="demo-card-wrap">
            ...
            <div class="demo-card">
                ...
                <div class="fg2">
                    <div class="fw"><label>Full Name <span class="req">*</span></label><input type="text" id="fname" name="full_name" placeholder="e.g. Rajesh Kumar"></div>
                    <div class="fw"><label>Email Address <span class="req">*</span></label><input type="email" id="email" name="email" placeholder="rajesh@yourcompany.com"></div>
                    ...
                    <div class="fw"><label>Company Located At</label><input type="text" id="company_location" name="company_location" placeholder="City, State, Country"></div>
                </div>
                ...
                <div style="margin-top:18px;">
                    ...
                    <div class="cbgrid" style="margin-top:12px;" id="cbGrid">
                        ...
                        <div class="ci" onclick="tick(this)" data-value="Gaming / Casino SMS"><div class="cbox"></div>🎮 Gaming / Casino SMS</div>
...
<?php
    ...
    $keyId = "rzp_test_Sg9QT6hO4ut4vB";
    // $keyId = "rzp_live_SP6kFizbnZSx1r";
    // $keySecret = "EpiEnXIOmIr2DWjY4e3pKzk6";
    $keySecret = "krDFZWKLtleaAOwbew3foVxV";
...
function pay() {
        ...
        var orderId = "<?php echo $orderId; ?>";
         var options = {
            "key": "rzp_test_Sg9QT6hO4ut4vB", // Enter the Key ID generated from the Dashboard
            "amount": "1499000", // Amount is in currency subunits.
            "currency": "INR",
